...
<head>
 ...
 <!--<link rel="stylesheet" href="<?php //echo web_root;?>pages/UI/icons.html"> -->
    <link rel="stylesheet" href="pages/UI/icons.html">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!-- Divider -->
            ...
            <hr class="sidebar-divider my-0">
                 <li class="nav-item  ">
                <a class="nav-link" href="Advisers.php">
                <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                    <span>Advisers</span>
                </a>
            </li>
                <li class="nav-item ">
                    <a class="nav-link" href="QualifiedInterns.php">
                    <i class="fas fa-check fa-sm fa-fw mr-2 text-gray-400"></i>
                        <span>Qualified Interns</span>
                    </a>      
             </li> 
             <li class="nav-item active">
                    <a class="nav-link" href="ongoinginterns.php">
                    <i class="fas fa-check fa-sm fa-fw mr-2 text-gray-400"></i>
                        <span>On going Interns</span>
                    </a>     
             </li>
             <li class="nav-item">
                    <a class="nav-link" href="doneinterns.php">
                    <i class="fas fa-check fa-sm fa-fw mr-2 text-gray-400"></i>
                        <span>Interns Done OJT</span>
                    </a>     
             </li>            
            <!-- Divider -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="Pstatus.php" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <i class="fa fa-fw fa-folder fa-sm fa-fw mr-2 text-gray-400"></i>
                    <span>Deployment Records</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="Graduating.php">Graduating</a>
                        ...
                        <!-- Illustrations -->	
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                	<form action="done-insert.php" method="POST">
                                     <h4 class="m-0 font-weight-bold text-dark">Details</h4> 
                                </div>
                                  
                                <?php
                                        $query = "SELECT * FROM ongoinginternship WHERE studentID =".$_GET['id'];
                              ...
                              <div class="form-group">
                                <div class="col-md-8">
                                  <label class="col-md-4 control-label" for="idno"></label>  
                                  	...
                                  	<button class="btn btn-primary btn-xs" name="save" type="submit" ></span> Done</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a class="btn btn-secondary" href="QualifiedInterns.php">
                        <span aria-hidden="true">×</span>
                    </a>
                </div>
                <div class="modal-body"><h3 class="text-center">Successfully Deploy!</h3></div>
                </div>
            </div>
        </div>-->
