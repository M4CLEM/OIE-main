                    ...
                    <div class="col-lg-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 d-flex justify-content-between">
                                <h3 class="m-0 font-weight-bold text-dark">List of Companies - <?php echo $department; ?></h3>
                                <div>
                                                        ...
                                                        <div class="row g-4">
                                                            ...
                                                            <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                                                <div class="d-flex mb-3">
                                                                    <a class="btn btn-primary mr-3" href='view-company.php?number=<?php echo $rows["No"]; ?>&dept=<?php echo $department; ?>'>View</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="functions/company-add-process.php?dept=<?php echo $department ?>" method="POST">
    ...
    <script>
        $(document).ready(function() {
            $(".export-btn").click(function() {
                ...
                window.location.href = "export_company.php?dept=" + department;
            });
        });
    </script>
