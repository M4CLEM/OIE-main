...
$query="select * from studentinfo where department ='CITCS'";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="Pgrade.php">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">  
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php (isset($_SESSION['adviser'])) ?> <?php echo $_SESSION['adviser']; ?></span>
                                    ...
                                    <table class="table">
                                        ...
                                        ?>
                                        	<tr>
	                                                ...
	                                                <td> 
	                                                	<a title="Edit" href="" class="btn btn-primary btn-xs"><span class="fa fa-edit fw-fa"></span>
	                                                	<a title="Delete" href="" class="btn btn-danger btn-xs"><span class="fa fa-trash"></a></span>
	                                                </td>
                                           		 </tr>
                                           	<?php 
                                        		}
